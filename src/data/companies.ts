...
export const companies: Company[] = [
  ...
  { name: "Gulbahar Cement", industry: "Industrial", description: "Largest cement manufacturer in Afghanistan — grey and white cement, phased capacity to 12,000 t/day, 5,000+ jobs.", logo: "/logos/gulbahar-cement.png", slug: "gulbahar-cement", linkTo: "project" },
  { name: "Gulbahar Energy", industry: "Energy", description: "Gas-fired generation in northern Afghanistan — 50–700 MW scale, DABS integration, MoWE / MoMP alignment.", logo: "/logos/gulbahar-power.png", slug: "gulbahar-power", linkTo: "project" },
