      ...
      <div className="relative z-10 flex min-h-[100dvh] flex-col">
        <div className="flex flex-1 flex-col items-center justify-center px-4 py-20 text-center sm:px-6 sm:py-24">
          <div className="mx-auto flex w-full max-w-5xl flex-col items-center">
            <p className="hero-animate hero-animate-delay-1 font-sans text-[0.65rem] font-semibold uppercase tracking-[0.38em] text-white/90 sm:text-xs sm:tracking-[0.42em]">{companyHero.eyebrow}</p>
            ...
            <p className="hero-animate hero-animate-delay-3 mx-auto mt-8 max-w-2xl font-sans text-base font-normal leading-relaxed text-white/82 sm:mt-10 sm:text-lg md:text-xl">{companyHero.subtitle}</p>
