  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border/60 bg-muted/20 shadow-sm ring-1 ring-black/[0.04]">
      <div className="aspect-[16/10] w-full min-h-[200px] sm:min-h-[240px]">
        <iframe title="Office location — Malik Azghar Square, Kabul" src={contact.mapsEmbedUrl} className="h-full w-full border-0 grayscale-[0.15] contrast-[1.02]" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen />
      </div>
