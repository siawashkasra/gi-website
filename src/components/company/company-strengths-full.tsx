      ...
      <div className="ds-container">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {competitiveStrengths.map((s) => (
            <div key={s.order} className="relative overflow-hidden rounded-2xl border border-border/60 bg-white p-7 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-xl">
