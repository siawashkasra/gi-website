...
import { getLocalizedClientsPartners, type Messages } from "@/lib/i18n/localized-data";

const easeLuxury = [0.16, 1, 0.3, 1] as const;

export function CompanyClientsSection() {
  const t = useTranslations("company.clients");
  const messages = useMessages() as Messages;
  const clientsPartners = getLocalizedClientsPartners(messages);
