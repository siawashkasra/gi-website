...
export function CompanyMarketGrowth() {
  return (
    <section id="market" className="ds-section border-b border-border/60 bg-section-alt" aria-labelledby="market-heading">
        ...
        <div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {marketPositioning.map((m) => (
              <article key={m.title} className="rounded-2xl border border-border/60 bg-card p-8 shadow-md">
