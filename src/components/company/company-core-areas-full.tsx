      ...
      <div className="ds-container">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-2">
          {coreBusinessAreas.map((area, i) => {
            ...
            return (
              <article key={area.title} className="flex flex-col rounded-2xl border border-border/60 bg-white p-8 shadow-xl transition-all duration-300 hover:border-primary/20 lg:p-10">
