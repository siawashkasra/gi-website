...
export function Hero() {
  ...
  const gradientOverlayBg = "linear-gradient(to bottom, rgba(26,58,107,0.76) 0%, rgba(26,58,107,0.58) 45%, rgba(26,58,107,0.78) 100%), radial-gradient(ellipse 90% 70% at 50% 100%, rgba(42,80,153,0.11), transparent 58%)";
