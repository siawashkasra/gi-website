...
const projectsHeroImage = "/images/projects/gulbahar-plaza/gulbahar-plaza-hero-page.png";
  ...
  return (
    <div className="border-b border-border/60">
      <div className="relative min-h-[22rem] overflow-hidden border-b border-border bg-primary text-primary-foreground sm:min-h-[26rem] lg:min-h-[30rem]">
        <Image src={projectsHeroImage} alt="" fill className="object-cover object-[center_42%]" sizes="100vw" priority />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-primary/46 via-primary/39 to-primary/33" aria-hidden />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_100%_80%_at_70%_-20%,color-mix(in_srgb,var(--color-primary-hover)_16%,transparent),transparent_52%)]" aria-hidden />
        ...
        <div className="relative ds-container py-24 sm:py-28 lg:py-36">
          <p className="font-sans text-xs font-semibold uppercase tracking-[0.36em] text-brand-complement">{siteConfig.name}</p>
