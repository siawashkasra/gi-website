...
export default function ProjectsPage() {
  return (
    <div className="border-b border-border/60">
      <div className="relative overflow-hidden border-b border-border/60 bg-[#0f172a] text-white">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_100%_80%_at_70%_-20%,rgba(201,169,110,0.28),transparent_52%)]" aria-hidden />
        ...
        <div className="relative ds-container py-24 sm:py-28 lg:py-36">
          <p className="font-sans text-xs font-semibold uppercase tracking-[0.36em] text-[#c9a96e]">{siteConfig.name}</p>
          <h1 className="mt-6 max-w-4xl font-serif text-5xl font-bold leading-[1.04] tracking-tight sm:text-6xl md:text-7xl md:leading-[1.02]">Our developments</h1>
