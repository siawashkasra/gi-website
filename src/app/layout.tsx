...
export const viewport: Viewport = { themeColor: [{ media: "(prefers-color-scheme: light)", color: "#111e41" }, { media: "(prefers-color-scheme: dark)", color: "#0d1b3e" }], width: "device-width", initialScale: 1 };
