    ...
    <div className="border-b border-border/60">
      <div className="ds-container ds-section max-w-3xl">
        ...
        <p className="mt-8 text-muted-foreground">
          Please use the contact form and select a clear subject line, or email <a href={`mailto:${siteConfig.email}`} className="font-medium text-primary underline-offset-4 hover:underline">{siteConfig.email}</a> with &quot;Complaint&quot; in the subject.
        </p>
